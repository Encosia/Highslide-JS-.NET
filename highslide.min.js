...
this.td[4].className=outlineType+' highslide-outline';this.preloadGraphic();};hs.Outline.prototype={preloadGraphic:function(){switch(this.outlineType){case"RoundedWhite":src='<%= WebResource("HighslideImage.graphics.roundedwhite.png") %>';break
